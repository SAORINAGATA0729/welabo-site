...
const productData: Record<string, any> = {
  ...
  "luxury-probiotics": {
    ...
    specs: {
      ...
      "栄養成分(1包 3粒当たり)": "エネルギー 3.91kcal, たんぱく質 0.03g, 脂質 0.04g, 炭水化物 0.86g, 食塩相当量 0.002g",
      "原産国": "日本"
    },
  ...
  "honsoureishihoushi": {
    ...
    specs: {
      ...
      "栄養成分(1包4000mgあたり)": "エネルギー 16.4kcal, たんぱく質 0.67g, 脂質 0.27g, 炭水化物 2.82g, 食塩相当量 0.009g",
      "原産国": "日本"
    },
    price: "¥91,800",
    amazonLink: "https://www.amazon.co.jp/",
      ...
      <main className="pt-32 md:pt-32">
        <div className="container mx-auto px-6 md:px-12">
          ...
          {product.capsuleSection && (
            <section className="mb-12 md:mb-24 py-12 md:py-16 mt-12 md:mt-24 border-t border-gray-100">
              <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
                <div className="flex-1 lg:flex-[2]">
