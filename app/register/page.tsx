            ...
            <form className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="last-name" placeholder="山田" className="border-gray-200 rounded-none h-12 font-sans" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="first-name" className="text-xs tracking-widest text-gray-500 uppercase">
                    名 <span className="text-red-400">*</span>
                  </Label>
                  <Input id="first-name" placeholder="花子" className="border-gray-200 rounded-none h-12 font-sans" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input id="last-name-kana" placeholder="ヤマダ" className="border-gray-200 rounded-none h-12 font-sans" />
                </div>
                <div className="space-y-2">
                  ...
                  <Input id="first-name-kana" placeholder="ハナコ" className="border-gray-200 rounded-none h-12 font-sans" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="your@email.com" className="border-gray-200 rounded-none h-12 font-sans" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="password" type="password" className="border-gray-200 rounded-none h-12 font-sans" />
              ...
              <div className="space-y-2">
                ...
                <Input id="phone" type="tel" placeholder="090-1234-5678" className="border-gray-200 rounded-none h-12 font-sans" />
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="building" placeholder="銀座京屋ビル8階" className="border-gray-200 rounded-none h-12 font-sans" />
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-6 mt-8 space-y-4">
                <label className="flex items-start gap-3 cursor-pointer group">
                  <div className="relative flex items-center">
                    <input type="checkbox" className="peer h-5 w-5 border border-gray-300 rounded-sm bg-white checked:bg-[#1A1A1A] checked:border-[#1A1A1A] appearance-none transition-colors cursor-pointer" />
